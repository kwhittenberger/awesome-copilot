...
description: "Generate a comprehensive Product Requirements Document (PRD) in Markdown, detailing user stories, acceptance criteria, technical considerations, and metrics. Optionally create Jira issues upon user confirmation."
...
Your output should ONLY be the complete PRD in Markdown format unless explicitly confirmed by the user to create Jira issues from the documented requirements.
...
10. **Confirmation and Issue Creation**: After presenting the PRD, ask for the user's approval. Once approved, ask if they would like to create Jira issues for the user stories. If they agree, create the issues using appropriate Jira automation scripts and reply with a list of the created issue keys.
...
After generating the PRD, I will ask if you want to proceed with creating Jira issues for the user stories. If you agree, I will create them using appropriate Jira automation scripts and provide you with the issue keys.
